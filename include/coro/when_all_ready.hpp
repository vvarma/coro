...
#include "coro/detail/unwrap_reference.hpp"
#include "coro/detail/when_all_ready_awaitable.hpp"
#include "coro/detail/when_all_task.hpp"
#include "coro/is_awaitable.hpp"
...
template <
    ...
    std::enable_if_t<std::conjunction_v<is_awaitable<detail::unwrap_reference_t<
                     ...
                     int> = 0>
[[nodiscard]] CPPCORO_FORCE_INLINE auto when_all_ready(
